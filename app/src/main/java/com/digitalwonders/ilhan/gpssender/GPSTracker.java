...
/**
 * Created by ilhan on 26.06.2015.
 */
public class GPSTracker extends Service implements LocationListener {
    ...
    public void setGPSTrackerListener(GPSTrackerListener g) {
        mGPSTrackerListener = g;
        mGPSTrackerListener.onLocationChanged(getLocation());
    }
    ...
    private void init() {
        ...
        if (!isGPSEnabled) {
            ...
            Log.i(TAG, "Registering for updates");
